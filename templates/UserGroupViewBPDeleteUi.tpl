...
{literal}
	function cancelremoveBP() {
		...
		document.getElementById('userGroupIdBP').value = '';
	}
{/literal}
</script>
	<div class="pop_up" id="deleteDialogBP">
		...
		<form action="index.php" method="post">
			...
			<input type="hidden" name="cmd" value="deleteblueprintfromusergroup"/>
			<input type="hidden" name="blueprintId" id="blueprintId" value=""/>
			<input type="hidden" name="userGroupIdBP" id="userGroupIdBP" value=""/>
			<input type="hidden" name="method" id="method" value="deleteBlueprintFromUserGroup"/>
...
{literal}
	...
	function deleteUserGroupBlueprint(userGroupId,blueprintId) {
		document.getElementById('userGroupIdBP').value = userGroupId;
		...
		var vOffset = document.getElementById('groupBlueprintPermissions').offsetTop;
