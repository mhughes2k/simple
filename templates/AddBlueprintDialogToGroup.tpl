...
<div class="pop_up_title">Add Blueprint To User/group</div>
<form action="index.php?option=siteAdmin&cmd=viewUserGroup&method=addBlueprint2UserGroup&userGroupId={$usergroup->id}#blueprintPermissions" method="post">
