...
{/literal}
	...
	<div class="pop_up" id="deleteDialog">
		...
		<form action="index.php" method="post">
			...
			<input type="hidden" name="cmd" value="removePlugin"/>
			<input type="hidden" name="pluginid" id="pluginid" value=""/>
...
{literal}
	function validatedelete() {
		if(document.getElementById('delete_confirm').value != '1') {
			alert('not deleting '+document.getElementById('pluginid').value);
			canceldelete();
			return false;
		}
		alert('deleting '+document.getElementById('pluginid').value);
		return true;
	}
